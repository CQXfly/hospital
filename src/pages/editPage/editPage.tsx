...
import { PatientUpdateInfo, UserManager } from '../../common/Server'
import { AtForm, AtInput, AtCheckbox, AtButton } from "taro-ui";

import './editPage.scss'
import { UserPatientModel } from "src/common/NetInterface";
    ...
    submitClick() {
        ...
        PatientUpdateInfo({
            ...
            gender: this.state.gender
                ...
                let mo = res as UserPatientModel
                Taro.setStorageSync(Keys.storageKeys.patient, mo)
                Taro.navigateBack({
                    delta: 1
                })
            })
