...
export default class HomePage extends Component<MyProps, MyState> {
    ...
    componentWillMount () { 
        console.log(`${this.props.category}======>${this.props.shouldRefresh}`)
    ...
    componentWillReceiveProps(nextProps) {
        let {category, shouldRefresh} = nextProps
        console.log(`${category} 页面会要判断一下要不要loading ${nextProps}`)
        if (!shouldRefresh) {
            return
        }
    ...
    onRefreshPullDown() {
        ...
        console.log('let me see category:', this.props.category)
        GetLessonListRequest({page: 1, category: this.props.category}).then(res=>{
            console.log(res)
            this.pageIndex = 2
    ...
    onRefreshPullUp() {
        ...
        GetLessonListRequest({page: this.pageIndex, category: this.props.category}).then(res=>{
            console.log(res)
            this.pageIndex += 1
